# The Emperor's Inner Canon — Suwen 8 Longform v1 (16 minutes)
...
1280×720**, `seedance_2_0_mini`, 96 blocks × 10s = **960.0s (16:00)**, MP4.
...
assumption. It is 96 clips to get wrong.
...
`SKILL.md` step 3, measured 2026-08-04:
...
**Every block below has been counted against those budgets and every one is
inside its voice's range** — counted by parsing this document's own narration
table and dropping tokens containing no letter or digit, because a spaced em-dash
is not a word and counting it as one spends real budget on a window 1.4s wide.
...
- **The short interjection is dead.** Under an 8.6s floor there is no quick jab,
  ...
  line is a full paragraph.** Lei-Gong's seven blocks are arguments, which is why
  he reads as the show's auditor rather than its mascot.
- **The rates are survivor-biased.** 3.65 w/s is what Arthur's *passing* takes
  delivered; across every recorded attempt on the one measured run he averaged
  **3.04 w/s**. These counts are sized for his fast mode and will regularly return
  over the ceiling.
...
| Block | Beat | Narration |
|---|---|---|
| 4 | Dr-Qi (Vesper) — the deflection | That is a most thorough question, and I am going to answer a slightly different one, because the ranking you are asking for does not exist. What exists is an arrangement. Let me set it out in full. |
| 5 | Arthur (V.O.) — what he got | He asked for a hierarchy and he was handed an organisation chart. Twelve organs, each given an office of state, each with a job title and a product. Nobody had described a body that way before. |
...
| Block | Beat | Narration |
|---|---|---|
| 6 | Arthur (V.O.) — the citation | The book is the Basic Questions, the first half of the Yellow Emperor's Inner Canon. Suwen, chapter eight. Its title names a room: the Chamber of the Numinous Orchid, where the Emperor locked this text away. |
...
| Block | Beat | Narration |
|---|---|---|
| 8 | Lei-Gong (Zane) — the auditor | Before anybody starts, I am writing this down. Twelve organs, twelve offices, and I intend to check the arithmetic at the end, because in my experience a government always has one more department than anybody admits. |
...
| 13 | Fan-di (Xavier) — the flattery | Then my heart is me. Not a pump, not a muscle, not a piece of offal a butcher would recognise, but the seat of the sovereign, which is convenient, because I happen to be one. Continue. |
...
| Block | Beat | Narration |
|---|---|---|
| 15 | Arthur (V.O.) — the plain verdict | We should say the plain thing now rather than at the end. Consciousness is not produced in the heart. It is produced in the brain, and on this the chapter is simply and completely wrong. |
| 16 | Arthur (V.O.) — the canon knows | What makes that interesting is that the same canon knows about the brain. Elsewhere it calls the brain the sea of marrow. The organ is described. It is simply never given an office. |
...
| Block | Beat | Narration |
|---|---|---|
| 18 | Lei-Gong (Zane) — the first finding | Then I have my first finding and we are one office in. There is no seat on this council for the organ that is doing the asking. The brain is not junior here. The brain is absent. |
...
| Block | Beat | Narration |
|---|---|---|
| 20 | Dr-Qi (Vesper) — the chancellor | Second office, and it is the second seat. The lung is the chancellor, the minister who stands beside the throne. From it issue regulation and rhythm, and it is the only organ placed directly next to the sovereign. |
| 21 | Arthur (V.O.) — 相傅 | Chancellor undersells it. The term is closer to minister and mentor together, the official who advises the ruler and administers what the ruler decides. Second in the state, and first in the day to day. |
| 22 | Arthur (V.O.) — 治節 | Regulation and rhythm is also one term, zhi jie. Jie is the joint in a bamboo, the notch, the measured interval. The lung is the office that keeps everything else on the beat. |
| 23 | Dr-Qi (Vesper) — why the lung | You can hear the argument for it. Breath is the one process a person can watch, and it never stops, and everything else in the body keeps time against it. You would put that official beside the throne too. |
...
| 25 | Arthur (V.O.) — the rhythm hit | The rhythm claim lands too. Your heart rate rises as you breathe in and falls as you breathe out, every breath, all day. The lung is measurably setting a beat the heart follows. |
| 26 | Arthur (V.O.) — the two scores | Mark that carefully, because the pattern repeats all episode. Right about the job. Wrong about the reason. A good observation fastened to a mechanism that does not exist, and the two scores stay separate. |
...
| 28 | Dr-Qi (Vesper) — stiller | It is a court with nobody in it. Every office in this list is a job, not a person, and the moment you start matching them to your ministers you will have stopped hearing what the chapter says. |
| 29 | Arthur (V.O.) — act out | There is the first payoff. A government is not a pile of officials, it is a set of relationships. Describe a body that way and you have a model of how parts depend on each other. |
...
| Block | Beat | Narration |
|---|---|---|
| 31 | Dr-Qi (Vesper) — the general | The liver is the office of the general, and from it issue planning and deliberation. Notice that the chapter does not say the general fights. It says the general is the one who thinks before anybody is asked to. |
...
| 33 | Dr-Qi (Vesper) — the defence | Because a campaign is lost before it is fought. The character here is the weighing of options under pressure, which is what a general does in the weeks nobody writes ballads about. It is not swordsmanship at all. |
...
| 35 | Arthur (V.O.) — what it does | What it does is quartermastery. Several hundred distinct chemical jobs. It builds the proteins that clot your blood, neutralises what you swallow, and holds the sugar reserve the rest of you draws on. |
| 36 | Arthur (V.O.) — wrong office, right army | So the department is oddly right and the faculty is wrong. Not the general who plans the battle. The general of supply, without whom the battle cannot be fought at all. Wrong office, right army. |

**ON-SCREEN TEXT — block 37.** Card: **膽者，中正之官，決斷出焉**.

| Block | Beat | Narration |
|---|---|---|
| 37 | Dr-Qi (Vesper) — the rectifier | The gallbladder is the office of the upright and impartial. From it issues decision. In your own government that post is held by a man who cannot be bribed, and that is the whole point of it. |
...
| Block | Beat | Narration |
|---|---|---|
| 39 | Lei-Gong (Zane) — the test | Second finding, and it is a test rather than a complaint. If you abolish one of these offices outright, does the government fall over? Because a chart that cannot answer that is not a chart, it is a poem. |
...
| Block | Beat | Narration |
|---|---|---|
| 41 | Dr-Qi (Vesper) — the envoy | The centre of the chest is the office of the envoy. From it issue joy and delight. This is the official who carries the sovereign's word out of the palace and brings the mood of the country back. |
...
| 43 | Arthur (V.O.) — the real observation | And here the chapter gets something right that we still cannot fully explain. Joy is felt in the chest. Not imagined there. Felt there, physically, and reported that way in every culture anyone has asked. |
| 44 | Arthur (V.O.) — right place, wrong workshop | The feeling is real and its location is real. What is not real is the chest making it. The sensation is assembled elsewhere and read off the body, which is a stranger arrangement than the chapter's. |
| 45 | Arthur (V.O.) — the running score | Right place, wrong workshop. That is now three times, and we are not yet halfway down the list. The chapter's eye is far better than its explanations, and the gap between them is the episode. |

**ON-SCREEN TEXT — block 46.** Card: **脾胃者，倉廩之官，五味出焉**.

| Block | Beat | Narration |
|---|---|---|
| 46 | Dr-Qi (Vesper) — the granary | The spleen and the stomach together are the office of the granaries. From them issue the five flavours. They hold what comes in, they release it at a rate, and the country eats or it does not. |
| 47 | Lei-Gong (Zane) — the count | Stop. Two organs, one office. That is eleven titles for twelve organs, and I have been promised twelve of each since the first sentence. Somebody in this granary is drawing a salary for another man's work. |
| 48 | Arthur (V.O.) — not a slip | He has found something, and it is not a slip. Every other office in the chapter takes one organ. This one takes two, and the pairing is where the chapter hides its single worst mistake. |
| 49 | Arthur (V.O.) — the stomach is right | The stomach belongs in a granary. It receives food, holds it, and passes it on, which is exactly the job description. On the stomach the chapter is straightforwardly correct, and it stays correct. |
...
| Block | Beat | Narration |
|---|---|---|
| 51 | Dr-Qi (Vesper) — the receiver | The small intestine is the office that receives what is abundant. From it issue transformed things. Whatever arrives from the granary is broken down here into what the body can actually take up and put to use. |
...
| Block | Beat | Narration |
|---|---|---|
| 53 | Dr-Qi (Vesper) — the road | The large intestine is the office of transmission along the road. From it issues change. What arrives is not merely carried through. It is altered on the way, and what leaves at the end is not what entered. |
| 54 | Arthur (V.O.) — a better hit | Also right, and better than they could have known. Your colon reclaims water, and it carries a population of microbes that rivals your own cells in number, and genuinely transforms what passes through it. |
...
| Block | Beat | Narration |
|---|---|---|
| 56 | Arthur (V.O.) — the act frame | Three offices left. One of them is a near miss so strange it deserves its own act, and one of them is a ministry with no building, which is not a mistake but a doctrine. |

**ON-SCREEN TEXT — block 57.** Card: **腎者，作強之官，伎巧出焉**.

| Block | Beat | Narration |
|---|---|---|
| 57 | Dr-Qi (Vesper) — the reserve | The kidney is the office of exertion. From it issue skill and dexterity. The claim is that hard effort and fine work are drawn out of the same reserve, and that the reserve is kept there, in the kidney. |
| 58 | Fan-di (Xavier) — the objection | Skill sits in my hands. I have spent years on my calligraphy and none of it in that region. Are you telling me that the finest brushwork in this palace is being produced somewhere behind my own back? |
| 59 | Dr-Qi (Vesper) — the answer | I am telling you the hands spend what the kidney stores. A man who cannot lift a bucket does not have steady brushwork either, and the chapter is claiming those two facts have a single cause behind them. |
| 60 | Arthur (V.O.) — better than filter | Your kidneys do not make dexterity, and nothing about fine motor control happens there. But the office of exertion is a much better guess than filter, which is what most people would say today. |
| 61 | Arthur (V.O.) — administration | They set your blood pressure. They finish the vitamin D that hardens your bones. They keep your blood's acidity in range. None of that is filtering, and all of it is administration rather than plumbing. |
...
| Block | Beat | Narration |
|---|---|---|
| 63 | Dr-Qi (Vesper) — the dredger | The triple burner is the office that clears the channels. From it issue the waterways. Every fluid in you moves along a route, and this office is responsible for keeping every one of those routes open and clear. |
...
| Block | Beat | Narration |
|---|---|---|
| 64 | Lei-Gong (Zane) — no building | Third finding, and this is the one I have actually done the work on. I have looked for that office. There is no building. There is a title, there is a job, and there is nothing there. |
| 65 | Arthur (V.O.) — he is right | He is right, and this is the most argued-over thing in Chinese medicine. The triple burner has no organ. Physicians have fought about it for two thousand years and it has never been located. |
| 66 | Arthur (V.O.) — a name and no form | A later text in the same tradition says it outright. It has a name and no form. That is a remarkable thing to write down and keep, rather than quietly deleting the office from the list. |
| 67 | Dr-Qi (Vesper) — the defence | Then let me defend it. An office is a function, not a room. You have never seen the thing that makes the post arrive on time either, and you would not abolish the post office to prove it. |
...
| 69 | Arthur (V.O.) — the lymphatics | The lymphatic system. It drains fluid out of your tissues and returns it, and Europe had no description of it at all until the middle of the seventeenth century, long after this was written. |
...
| 72 | Arthur (V.O.) — the conditional | Every other office simply produces. This one produces only if something else works first, which is a more careful claim than anything around it and, as it happens, an accurate description of a bladder. |
...
| Block | Beat | Narration |
|---|---|---|
| 74 | Dr-Qi (Vesper) — the sentence | That is all twelve. And now the sentence that matters more than any of them. These twelve offices must never lose one another. Not one of them can be dispensed with, and none of them works alone. |
| 75 | Arthur (V.O.) — the question dissolves | Go back to the question he asked. Which is noble and which is base. He wanted a ranking, and what he has been handed is a sentence saying the ranking cannot be acted on. |
...
| Block | Beat | Narration |
|---|---|---|
| 77 | Dr-Qi (Vesper) — the bright ruler | When the ruler is clear-sighted, those below him are at peace. The text then says that a life cultivated on this principle is a long one. That is what it claims. I am quoting it, not prescribing it. |
| 78 | Arthur (V.O.) — the hedge | We should be plain about that clause. It is a claim the text makes about virtue and long life, and it is not a finding, not evidence, and emphatically not a recommendation to anybody watching. |
...
| Block | Beat | Narration |
|---|---|---|
| 79 | Dr-Qi (Vesper) — the dark ruler | And then the other half, which I will read exactly as written. If the ruler is not clear-sighted, the twelve offices are endangered. The roads close and do not carry anything at all. The body is greatly injured. |
| 80 | Arthur (V.O.) — who is in the room | Read that again and notice who is in the room. A physician has just told the man on the throne that an unclear sovereign wrecks the state, and he has said it as a medical observation. |
...
| Block | Beat | Narration |
|---|---|---|
| 81 | Fan-di (Xavier) — he hears it | You are not describing my liver. You have been describing my court for a quarter of an hour and I have been sitting here nodding along, agreeing with every word, like a man applauding his own indictment. |
| 82 | Arthur (V.O.) — 使道 | There is a word in that passage worth stopping on. The roads. The routes the envoys travel. When they close, the offices are intact and the state fails anyway, because the failure is in the traffic. |
| 83 | Arthur (V.O.) — the systems claim | That is a systems claim, and it is the most modern sentence in the chapter. Illness as a breakdown in signalling between organs, rather than damage inside one, is roughly where medicine has arrived. |
| 84 | Lei-Gong (Zane) — the verdict | Then I will answer my own question, since nobody else has. You can abolish an office. Surgeons remove the gallbladder hundreds of thousands of times a year, and the government carries on without it. |
| 85 | Arthur (V.O.) — false as stated | So the chapter's strongest claim is false as stated. One of the twelve can be removed, and the man who loses it keeps his judgment, his decisions and every other office in working order. |

**ON-SCREEN TEXT — block 86.** Card: **戒之戒之** — four characters, alone, held.

| Block | Beat | Narration |
|---|---|---|
| 86 | Dr-Qi (Vesper) — take care | The chapter closes that passage by repeating itself, which it does nowhere else in the text. Take care. Take care. Twice, in four characters, at the end of a warning addressed to a reigning sovereign by his own physician. |
...
| Block | Beat | Narration |
|---|---|---|
| 87 | Arthur (V.O.) — the turn | One passage left, and it is not about organs at all. The ultimate way lies in the minute. Its transformations have no end. Who knows where it begins. The chapter turns philosophical in its final lines. |
| 88 | Dr-Qi (Vesper) — measurement | The numbers of what is faint and indistinct are born from the finest hair. The numbers of the hair arise from measurement. Multiply them by thousands and by ten thousands, extend them, and a form is thereby determined. |
| 89 | Arthur (V.O.) — what that claims | That is a claim about measurement, and it is a bold one. The vague becomes exact by being counted. Start from something too small to see, count it, scale it, and you arrive at a shape. |
...
| Block | Beat | Narration |
|---|---|---|
| 90 | Fan-di (Xavier) — the fast | Then I will not take this casually. I have heard the way of refined brilliance and the work of a great sage, and without fasting and purification and a chosen day, I do not dare receive it. |
| 91 | Arthur (V.O.) — and he does | And he does exactly that. He fasts, he purifies himself, he waits for a day with a favourable omen, and then he puts the text away in a room and has it kept there. |
...
| Block | Beat | Narration |
|---|---|---|
| 93 | Lei-Gong (Zane) — the last finding | Last finding, and then I will stop counting. Nobody in this room disagreed with the metaphor. Not once. You cannot audit a government from inside it, and every one of us has been standing inside this one. |
| 94 | Arthur (V.O.) — the thesis | That is the episode. The heart kept the throne for two thousand years not because the evidence was good, but because the metaphor was, and a good metaphor is very hard to argue with. |
| 95 | Arthur (V.O.) — and we do it now | And we are doing it now. The brain as a computer. The genome as a blueprint. The immune system as an army. Each explains something, each is wrong somewhere, and each is hard to put down. |
| 96 | Arthur (V.O.) — disclaimer card | A dramatized adaptation of a classical philosophical text. Not medical advice. We present the Inner Canon as history and philosophy, and we say plainly, every time, where the evidence does not support it. |
...
Last figure implied by the recorded runs: **~782**, unread since 2026-08-04.

| Clip model / tier | Credits/clip | × 96 blocks | vs ~782 |
|---|---|---|---|
| `seedance_2_0_mini` 480p (default, draft) | 10 | **~960** | **over budget** |
| `seedance_2_0_mini` 720p (default, full) | 25 | ~2,400 | ~3.1× balance |
| `gemini_omni` 720p | 30 | ~2,880 | ~3.7× balance |
| `seedance_2_0` 1080p | 90 | ~8,640 | ~11× balance |

Everything else is trivial by comparison: a vertical chapter key at **2** plus a
landscape sibling at **2**, 96 voice takes at **~0.8** ≈ 77, assembly **free**,
captions **free**. **Clips are essentially the entire bill, so the model choice is
the budget.**

**A 16-minute episode does not fit at any tier — not even an all-draft pass.**
Three ways forward, and it is a decision, not a detail:

1. **Top up** before starting.
2. **Cut the runtime.** 90 blocks (15:00) at 480p is ~900 — still over, with
   nothing left for re-takes. See the runtime levers.
...
**Budget re-takes separately and generously.** On the one measured run a single
block took fourteen takes and ~11 credits. At 96 blocks even a 20% re-take rate is
~15 extra credits of voice — cheap — but the *time* cost is the real one, and it
is what makes whole-episode single-pass assembly risky.

### Voice measurement — required before 96 takes
...
- **Zane has never been measured at length.** The only figure on record is a
  five-word line at 2.3–2.6s, where pause overhead dominates. **Lei-Gong has seven
  blocks here (8, 18, 39, 47, 64, 84, 93)**, each written at 36–39 words
  provisionally. Under a hard 8.6s floor an unmeasured voice is a render failure,
  not a rounding error.
- **Vesper was measured on a single trailer beat.** This script asks her for
  sustained explanatory paragraphs across 23 blocks, which is not what she was
  measured on.
...
Four takes, ~3.2 credits. A mis-sized script is 96.

**Cheaper still: the companion trailer is Zane's measurement vehicle.**
`inner-canon-suwen8-trailer-v1.md` gives him one 36-word block. Render the trailer
first and his rate arrives as a by-product of a cut you were making anyway.

**Named fallback if Zane will not hold the window.** Blocks 8, 39, 47, 64 and 84
can be **reassigned to Arthur as reported speech** without changing the block
count, the act boundaries or the shot list — recast as *"The boy behind the pillar
had already counted eleven titles against twelve organs"* and so on. **Blocks 18
and 93 are the two that cannot be recast**, because their force comes from the
youngest person present being the one who says it. If Zane fails measurement,
those become Arthur blocks **and the episode loses both of its best lines** — so
decide this **before generating the cold open**, not at Act V.

### Style key — needs a new chapter key and a 16:9 sibling

The chained lineage is 9:16 and belongs to Suwen 1. This chapter needs its own key,
and longform additionally needs a **landscape variant**.

1. Derive the **Suwen 8 vertical key** by chaining off the current head
   `4b6f7106-67da-4d1a-a553-c58ba90ac43f`, passing its **job ID** as the reference
   and swapping only the motif. Motif: the three-character series key with a
   **lacquer organisation chart of twelve empty boxes** on the wall behind them,
   and a **closed lacquer chest** at Fan-di's feet. `nano_banana_pro`, 9:16
   768×1376.
...
- **Pre-decline `IN THE DARK`** (`24bae836-2c4a-48e0-89b6-49fcc0b21612`) on every
  clip. **Act III is lamp-on-black for eighteen consecutive blocks and Act V for
  ten**, which is the most frequent trigger by far. One id per call, so budget a
...
- **Keep audio vocabulary out of clip prompts** — *drum*, *drone*, *music*,
  *rhythm* — since those are edit-time directions anyway and *rhythm* triggers
  ...
  "brush ticking" and block 25's breath rhythm are SOUND and VISUAL directions
  respectively and must not reach a clip prompt as rhythm vocabulary.
...
- **Duration ≥ 9.5s and motion from frame 1.** The assembler rejects a clip shorter
  ...
  are the deliberately still ones**: 19 (the unconnected box), 40 (one box while the
  chart dims), 64 (the brush held over an empty box), 78 (a chart that deliberately
  does not change), 81 (the fan on the table), 86 (four characters held), 96 (the
  plate). Stillness in the staging must not become a frozen frame in the clip — give
  each a slow push, drifting ink grain, or a light change.
...
- **Assemble the whole episode in one call** and skip the join. Removes the
  problem, but it is 192 files to download inside one chained command, in a sandbox
...
- **Concat the act outputs** with our own ffmpeg, outside the sandbox's rules.
  ...
  Act II → III where the brush ticking stops and the sustained note starts, and
  Act IV → V where everything drops to room tone.
...
**Assemble the cold open plus Act I first (blocks 1–29) and measure how long it
...
| Voice | Blocks | Count |
|---|---|---|
| Arthur | 1, 2, 5, 6, 7, 9, 11, 12, 15, 16, 17, 19, 21, 22, 24, 25, 26, 29, 30, 34, 35, 36, 38, 40, 42, 43, 44, 45, 48, 49, 50, 52, 54, 55, 56, 60, 61, 62, 65, 66, 68, 69, 70, 72, 73, 75, 78, 80, 82, 83, 85, 87, 89, 91, 92, 94, 95, 96 | 58 |
| Vesper (Dr-Qi) | 4, 10, 14, 20, 23, 28, 31, 33, 37, 41, 46, 51, 53, 57, 59, 63, 67, 71, 74, 77, 79, 86, 88 | 23 |
| Xavier (Fan-di) | 3, 13, 27, 32, 58, 76, 81, 90 | 8 |
| Zane (Lei-Gong) | 8, 18, 39, 47, 64, 84, 93 | 7 |

58 + 23 + 8 + 7 = **96**, one take per block, no block with two speakers.
...
```
node scripts/check_caption_fit.js output/suwen/ch8/inner-canon-suwen8-longform-v1.md --format 16:9
node scripts/build_subtitles.js  output/suwen/ch8/inner-canon-suwen8-longform-v1.md --format 16:9
```
...
- **Two style keys are needed and neither exists** — a Suwen 8 vertical key and its
  16:9 sibling. Record both here and promote the vertical one to `SKILL.md` step 1.
- **The 16:9 decision is unconfirmed** and is 96 clips to get wrong.
- **Zane is unmeasured at length**; seven blocks depend on him and the recast
  fallback covers five of the seven. Blocks 18 and 93 do not survive the recast
  intact — decide before generating.
- **This is `output/suwen/`'s first chapter folder.** The book folder is new; the
  scripts hold no folder assumptions, and the sweep glob `output/*/ch*/*-v*.md`
  already covers it.
...
- **Source provenance:** the chapter arrived as a user-supplied PDF of the ctext
  edition, because `ctext.org` is denied at CONNECT from this host. The classical
  text above was transcribed from that PDF and is in **simplified** characters in
  the source; the cards and the source section here use **traditional** forms, which
  is the repo's on-screen convention. **Verify every card glyph against a
  traditional-character edition before burning them** — the conversion is
  mechanical for most of these clauses but 藏/髒, 焦 and 膽 are exactly where a
  wrong form would go unnoticed.
...
- **End disclaimer card** — mandated string verbatim, over block 96.
...
This cut's own numbers — 96 blocks, 960.0s, act boundaries at 1:30 / 4:50 / 9:10 /
12:10 / 14:20, end card **15:50 to 16:00**. Not a generic recipe: block numbering
...
libass margins keep them in frame. Fix at script stage anyway: after recording it
costs a re-take.
...
On a **copy** of the `.srt`, delete the cues covering **block 96** (everything from
15:50) so the disclaimer is not simultaneously a caption and a card. The burn copy
is blocks 1–95, ending at 15:50.
...
at 0:09, over block 1's self-drawing chart. At 16:9 `MarginV` is 60, so keep the
lower-third higher than the caption band or move it to the upper third for this cut.
Added by `drawtext` in the burn pass, not in an NLE.

**5. Quotation cards.** If the nineteen cards listed above were rendered as **plain
...
|---|---|---|---|
| Block 3 | 0:20 | Block 57 | 9:20 |
| Block 6 | 0:50 | Block 63 | 10:20 |
| Block 10 | 1:30 | Block 71 | 11:40 |
| Block 20 | 3:10 | Block 74 | 12:10 |
| Block 31 | 5:00 | Block 77 | 12:40 |
| Block 37 | 6:00 | Block 79 | 13:00 |
| Block 41 | 6:40 | Block 86 | 14:10 |
| Block 46 | 7:30 | Block 87 | 14:20 |
| Block 51 | 8:20 | Block 92 | 15:10 |
| Block 53 | 8:40 | | |
...
**Block 71 is the widest card in the episode** — thirteen characters plus two commas
— and block 79 is the second at twelve. Both need a smaller point size than the
four-character cards; set them individually rather than applying one card style
across all nineteen.

**6. End card — 15:50 to 16:00** (block 96). Mandated disclaimer verbatim across
...
all of Act III (blocks 56–73)** — the act is built on a single sustained note and a
guqin bed under it would fight rather than support. Back in under block 74. **Out
again at block 87 and never returns**: Act V plays on room tone alone, and the
...
- **Anatomy and gore** — **absent by construction.** Every organ in this episode is
  ...
  16's brain is *"an outline of a skull drawn as a vessel of marrow, no features"*,
  which is the single closest approach and is still a container, not a body.
...
- **Prompt-stage audit** — the shot list is low-risk throughout: a chart, boxes,
  seals, a granary door, a road, a cistern, a lamp, a closed chest. **No restraint or
  bound-figure imagery**, which has tripped the safety filter here before even on
  innocuous subject matter. No bodies, no injury, no falling figures. **Three items
  to watch at prompt stage:** (a) shot 16's skull-as-vessel is the one frame that
  could read as anatomical — keep it a *brushed container*, and if it triggers,
  replace it with a sealed jar of marrow and lose nothing; (b) shot 38's refused
  purse must stay **objects only**, no faces, or it reads as a bribery scene; (c)
  Act III and Act V are twenty-eight lamp-lit blocks against black and will trigger
  `IN THE DARK` repeatedly — pre-decline on every one of them.

...
- **Music** — licensed guqin only; nothing generated by this pipeline. Trailers earn disproportionate plays and carry the higher Content-ID exposure. The assembler *can* now lay a licensed bed under the cut at mix time, which makes this optionally an assembly step rather than strictly a hand one; the licensing rule is unchanged either way, and the other three remain manual.
